	...
	const saveSettings = async () => {
		...
		try {
			...
			setSaveMessage({
				...
				text:
					error.message ||
					__('Failed to save settings.', 'side-cart'),
			});
		} finally {
			setIsSaving(false);
		}
			...
			<Card>
				<CardBody>
					...
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('show_floating_basket', value)
						}
					/>
					<SelectControl
						...
						onChange={(value) =>
							updateSetting('basket_position', value)
						}
					/>
					<SelectControl
						...
						onChange={(value) =>
							updateSetting('drawer_position', value)
						}
					/>
					<SelectControl
						...
						onChange={(value) =>
							updateSetting('badge_count_mode', value)
						}
					/>
					<TextControl
			...
			<Card>
				<CardBody>
					...
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('show_drawer_heading', value)
						}
					/>
					<TextControl
			...
			<Card>
				<CardBody>
					...
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('show_free_shipping_bar', value)
						}
					/>
					<TextControl
						...
						onChange={(value) =>
							updateSetting('free_shipping_message', value)
						}
					/>
					<TextControl
					...
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('show_empty_state_icon', value)
						}
					/>
					<TextControl
			...
			<Card>
				<CardBody>
					...
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('show_item_image', value)
						}
					/>
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('show_item_name', value)
						}
					/>
					<ToggleControl
					...
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('show_item_variation', value)
						}
					/>
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('show_item_price', value)
						}
					/>
					{settings.show_item_price && (
						<SelectControl
							...
							options={[
								{ label: __('Individual price', 'side-cart'), value: 'individual' },
								{ label: __('Line total (price × quantity)', 'side-cart'), value: 'line_total' },
							]}
							onChange={(value) =>
								updateSetting('item_price_mode', value)
							}
						/>
					)}
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('show_item_quantity', value)
						}
					/>
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('show_item_remove', value)
						}
					/>
				</CardBody>
			</Card>
			...
			<Card>
				<CardBody>
					...
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('show_coupon_input', value)
						}
					/>
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('show_cart_totals', value)
						}
					/>
					{settings.show_cart_totals && (
						<>
							<ToggleControl
								...
								onChange={(value) =>
									updateSetting('show_subtotal', value)
								}
							/>
							<ToggleControl
								...
								onChange={(value) =>
									updateSetting('show_shipping', value)
								}
							/>
							<ToggleControl
								...
								onChange={(value) =>
									updateSetting('show_taxes', value)
								}
							/>
							<ToggleControl
								...
								onChange={(value) =>
									updateSetting('show_discounts', value)
								}
							/>
							<ToggleControl
								...
								onChange={(value) =>
									updateSetting('show_total', value)
								}
							/>
						</>
					)}
			...
			<Card>
				<CardBody>
					...
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('show_view_cart_button', value)
						}
					/>
					<ToggleControl
						label={__(
						...
						onChange={(value) =>
							updateSetting('show_continue_shopping', value)
						}
					/>
					{settings.show_continue_shopping && (
						<>
							<SelectControl
								...
								onChange={(value) =>
									updateSetting('continue_shopping', value)
								}
							/>
					...
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('show_checkout_button', value)
						}
					/>
				</CardBody>
			</Card>
			...
			<Card>
				<CardBody>
					...
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('load_plugin_stylesheet', value)
						}
					/>
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('customize_appearance', value)
						}
					...
					<Card>
						<CardBody>
							...
							<ColorControl
								...
								onChange={(value) =>
									updateSetting('primary_text_color', value)
								}
							/>
							<ColorControl
								...
								onChange={(value) =>
									updateSetting('drawer_bg_color', value)
								}
							/>
							<ColorControl
								label={__(
								...
								onChange={(value) =>
									updateSetting('drawer_header_bg', value)
								}
							/>
							<ColorControl
								label={__(
								...
								onChange={(value) =>
									updateSetting('drawer_footer_bg', value)
								}
							/>
							<ColorControl
								...
								onChange={(value) =>
									updateSetting('text_color', value)
								}
							/>
							<ColorControl
								...
								onChange={(value) =>
									updateSetting('border_color', value)
								}
							/>
							<TextControl
								...
								onChange={(value) =>
									updateSetting('overlay_color', value)
								}
							/>
						</CardBody>
					</Card>
					...
					<Card>
						<CardBody>
							...
							<RangeControl
								...
								onChange={(value) =>
									updateSetting('drawer_width', value)
								}
								min={300}
								max={600}
							/>
							<RangeControl
								...
								onChange={(value) =>
									updateSetting('border_radius', value)
								}
								min={0}
								max={24}
							/>
							<RangeControl
								...
								onChange={(value) =>
									updateSetting('button_radius', value)
								}
								min={0}
								max={24}
							/>
							<RangeControl
								...
								onChange={(value) =>
									updateSetting('overlay_blur', value)
								}
								min={0}
								max={20}
							/>
					...
					<Card>
						<CardBody>
							...
							<RangeControl
								...
								onChange={(value) =>
									updateSetting('item_image_size', value)
								}
								min={48}
								max={120}
							/>
							<RangeControl
								...
								onChange={(value) =>
									updateSetting('item_image_radius', value)
								}
								min={0}
								max={24}
							/>
					...
					<Card>
						<CardBody>
							...
							<ColorControl
								...
								onChange={(value) =>
									updateSetting('basket_color', value)
								}
							/>
							<RangeControl
								...
								onChange={(value) =>
									updateSetting('basket_size', value)
								}
								min={40}
								max={80}
							/>
							<TextControl
								...
								onChange={(value) =>
									updateSetting('basket_radius', value)
								}
							/>
						</CardBody>
					</Card>
					...
					<Card>
						<CardBody>
							...
							<ColorControl
								...
								onChange={(value) =>
									updateSetting('badge_color', value)
								}
							/>
						</CardBody>
					</Card>
					...
					<Card>
						<CardBody>
							...
							<SelectControl
								...
								onChange={(value) =>
									updateSetting('drawer_animation', value)
								}
							/>
						</CardBody>
					</Card>
					...
					<Card>
						<CardBody>
							...
							<ColorControl
								...
								onChange={(value) =>
									updateSetting('toast_color', value)
								}
							/>
						</CardBody>
					</Card>
					...
					<Card>
						<CardBody>
							...
							<ColorControl
								...
								onChange={(value) =>
									updateSetting('empty_state_color', value)
								}
							/>
						</CardBody>
					</Card>
			...
			<Card>
				<CardBody>
					...
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('hide_on_cart_page', value)
						}
					/>
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('hide_on_checkout', value)
						}
					/>
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('override_cart_redirect', value)
						}
					/>
				</CardBody>
			</Card>
			...
			<Card>
				<CardBody>
					...
					<ToggleControl
						...
						onChange={(value) =>
							updateSetting('compat_mode', value)
						}
					/>
		...
		<Card>
			<CardBody>
				...
				<p>
					...
					<strong>{settings.license_status || __('Not activated', 'side-cart')}</strong>
				</p>
				<Notice status="info" isDismissible={false}>
					{__(
